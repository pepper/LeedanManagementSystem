...
export default class MainMenu extends Component{
	constructor(props){
		super(props);
		this.state = {
			menuItemList: new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2}),
		};
...
// 		this.setState({
// 			main_menu_item: this.rebuildMenuDataSource(nextProps.moduleList),
// 		});
// 	},
...
// 						if(item.empty){
// 							return <View style={style.menuItem}></View>
// 						}
// 						return (
// 							<MenuItem {...item} style={{menuItem: style.menuItem}} selected={(this.props.currentModule && this.props.currentModule.id == item.id)} />
// 						);
// 					}.bind(this)}
// 				/>
// 			</View>
...
// var Size = require("../../definitions/size")[Config.getPlatform()];

// var styles = {};

// styles.ios = StyleSheet.create({
// 	container:{
// 		width: Size.main_menu_width,
// 		backgroundColor: Color.yellow,
// 	},
// 	logoContainer:{
// 		width: Size.main_menu_width,
// 		height: Size.second_menu_title_height,
// 		borderColor: Color.light_yellow,
// 		borderBottomWidth: 0.5,
// 		alignItems: "center",
...
// 		alignItems: "center",
// 		justifyContent: "center",
// 		height: Size.second_menu_item_default_height,
// 		borderColor: Color.light_yellow,
// 		borderBottomWidth: 0.5,
// 	},
// });
