...
export default class MainMenu extends Component{
	static propTypes = {
		moduleListDatasource: PropTypes.object,
		...
		if(rowData.key && rowData.key != ""){
			...
			return (
				<MenuItem
					...
					menuItemKey={rowData.key}
					onPress={this.props.onChangeModule}
				/>
			);
		}
		else{
